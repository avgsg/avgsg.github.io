...
<!-- 2. Costa, L. C., Vieira, A. B., Silva, E. B, Macedo, D. F., Vieira, L. F. M., Vieira, M. A. M, Miranda Jr, M. R., Batista, G. F., Polizer, A. H., **Gomes, A.**, Gomes, G., Correia, L. H. A (2021). _OpenFlow data planes performance evaluation_. In ELSEVIER Journal of Performance Evaluation. [Paper URL](https://www.sciencedirect.com/science/article/abs/pii/S0166531621000110).  -->
...
**Publications:** <br>
[1] Gomes, A., Kibiłda, J., Farhang, A., Farrell, R., and DaSilva, L. A (2020). _Network Sharing for Reliable Networks: A Data-Driven Study_. In IEEE International Conference on Communication (ICC). [PDF](../files/papers/icc-2020-net-sharing.pdf).
